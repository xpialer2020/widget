	...
	*/
	...
	$(document).ready(function(){
		...
		function t(e){
			...
			if( i && "none" != i ){
                let s=i.split("(")[1];
                    s=s.split(")")[0],
					s=s.split(",");
                for(let n=s[0], l=s[1], o=Math.round(Math.atan2(l,n)*(180/Math.PI)) ; o>=360 ;){
                    o = 360 - o;
                    for(; 0>o ;){
                        o = 360 + o;
                        return o;
        ...
        $.getCorrection=function(e,t,i,s,n){
            var n=n*Math.PI/180,
                l=-e/2,
                o=t/2,
                a=o*Math.sin(n)+l*Math.cos(n),
                r=o*Math.cos(n)-l*Math.sin(n),
                h={
                    left:a-l,top:r-o
                },
                c=e+i,
