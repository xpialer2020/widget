	...
	*/
	...
	$(document).ready(function(){
		...
		function t(e){
			...
			null;
			if(i&&"none"!=i){
				var s=i.split("(")[1];s=s.split(")")[0],
					s=s.split(",");
				for(var n=s[0],l=s[1],o=Math.round(Math.atan2(l,n)*(180/Math.PI)) ; o>=360 ;)o=360-o;for(;0>o;)o=360+o;return o
			}
			return 0
		}
		function i(e){
